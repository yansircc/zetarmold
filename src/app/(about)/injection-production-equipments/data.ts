// Define the interface for the equipment data
interface InjectionProductionEquipment {
  no: number;
  brand: string;
...
// Create an array of equipment data
const injectionProductionEquipments: InjectionProductionEquipment[] = [
  {
    no: 1,
    brand: 'FengTie',
    machineTonnage: '90T',
...
export type { InjectionProductionEquipment };
export { injectionProductionEquipments };
